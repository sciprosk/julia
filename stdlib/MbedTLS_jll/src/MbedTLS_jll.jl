...
const libmbedcrypto_path = LazyStringFunc(() -> joinpath(dirname(Sys.BINDIR), libmbedcrypto_name))
const libmbedtls_path = LazyStringFunc(() -> joinpath(dirname(Sys.BINDIR), libmbedtls_name))
const libmbedx509_path = LazyStringFunc(() -> joinpath(dirname(Sys.BINDIR), libmbedx509_name))
